...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x79BEE7), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 68, 200);
    lv_obj_set_size(ui->screen_btn_2, 100, 50);
    ui->screen_btn_2_label = lv_label_create(ui->screen_btn_2);
    lv_label_set_text(ui->screen_btn_2_label, "人员信息");
    ...
    lv_obj_set_style_text_font(ui->screen_btn_2, &lv_font_youyuan_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_btn_4 = lv_button_create(ui->screen_cont_1);
